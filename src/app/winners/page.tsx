      ...
      <div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="max-w-screen-xl mx-auto px-6">
            ...
            <p className='mb-12 text-left text-lg text-gray-600'>Han confiado y han ganado participando en Piyango.</p>

            <hr/>

            <p className="text-center text-gray-500 mt-8 mb-72">Aún no hay ganadores disponibles para mostrar</p>
