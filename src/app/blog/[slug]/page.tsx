import '@/app/styles/blog.css' // importa aquí el blog.css
                ...
                <div className="container max-w-screen-md mx-auto md:px-0 px-4">
                    <div>
                        <div>
                            ...
                            <h2 className="text-dark dark:text-white md:text-52 text-3xl leading-[1.2] font-semibold pt-7">
                                {post.title}
                            </h2>
                    ...
                    <div className="z-20 mt-2 overflow-hidden rounded">
                        <Image
                            src={post.coverImage}
                            alt="image"
                            width={1170}
